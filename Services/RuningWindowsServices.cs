...
namespace ExtendCSharp.Services
{
    ...
    public class RuningWindowsServices : IService
    {
        internal event EventHandler WindowActivatedChanged;
        internal System.Windows.Forms.Timer TimerWatcher = new System.Windows.Forms.Timer();
        internal InfoWindow WindowActive = new InfoWindow();
        internal void DoStartWatcher()
        {
        ...
        public IDictionary<IntPtr, InfoWindow> GetOpenedWindows()
        {
        ...
        void TimerWatcher_Tick(object sender, EventArgs e)
        {
